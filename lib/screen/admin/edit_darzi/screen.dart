...
class EditDarziScreen extends StatefulWidget {
  const EditDarziScreen({
    super.key,
    required this.darziInfo,
  });

  final DarziInfo darziInfo;
  @override
  State<EditDarziScreen> createState() => _EditDarziScreenState();
}

class _EditDarziScreenState extends State<EditDarziScreen> {
  final controller = Get.find<EditDarziController>();
  @override
  void initState() {
    controller.onScreenInit(widget.darziInfo);
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: Btn.floating(
        ...
        onTap: () => controller.editDarzi(widget.darziInfo),
      ),
      appBar: AppBar(
        title: const Text(
          "Edit Darzi",
            ...
            Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const HeaderTile(title: 'Services'),
                  Obx(() {
